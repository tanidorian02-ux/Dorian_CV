      ...
      <section className="creative reveal">
        ...
        <div className="creative-grid">
          {[
            ...
            { href:'/haven/haven-homepage.html', cls:'', preview:'preview-haven', badge:'Editorial · Immo', title:'HAVEN', type:'Immobilier · Hainaut', name:'Haven Immobilier', desc:'Landing fictive pour une agence immobilière locale.', tags:['Editorial','Immo'], disabled:false },
